...
// TODO REMOVE
var citiesApi1 = "https://b052efc6a43a.ngrok.io/atlassian-connect.json";
...
// Global constants.
var MAX_CITIES = 6;
var baseApiUrl = "https://b052efc6a43a.ngrok.io";
var citiesApi = baseApiUrl + "/cities1.json";

var getWoeidApi = baseApiUrl + "/getWoeid?";
var suggestCities = baseApiUrl + "/cities?city=";

//http://api.geonames.org/timezoneJSON?username=optiklab&lng=-75.499901&lat=43.000351
var timeZonesApi = "https://api.geonames.org/timezoneJSON?username=optiklab&";
    ...
    $.getJSON('https://api.hostip.info/get_json.php')
        .done(
            ...
            if (data && data.ip) {
                ...
                $.ajax({
                    method: 'get',
                    url: 'https://api.ipinfodb.com/v3/ip-city/?key=debfc7c448e8b9d818084949fa23db2382f2488fbfd52e805a3e059091c65d8b&ip=' + data.ip + '&format=json',
                    ...
                    success: function (location) {
                        ...
                        if (location && location.countryName && location.cityName) {
                            ...
                            $.ajax({
                                method: 'get',
                                url: getWoeidApi + "city=" + location.cityName + "&country=" + location.countryName,
    ...
    $('#city-location').autocomplete({
        source: function (request, response) {
            ...
            if (cityName && cityName.length > 0) {
                ...
                // TODO
                $.getJSON(citiesApi,
                //$.getJSON(suggestCities + cityName,   <--TODO
                    function(json) {
